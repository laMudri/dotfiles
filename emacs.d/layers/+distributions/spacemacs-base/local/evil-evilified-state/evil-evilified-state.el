...
(require 'evil)
(require 'bind-map)
<<<<<<< HEAD:layers/+distributions/spacemacs-base/local/evil-evilified-state/evil-evilified-state.el
=======

(defvar evilified-state--modes nil
  "List of all evilified modes.")
>>>>>>> 9f9faa404e3dec3e08cc73cf7b5a0439fc309800:layers/+distribution/spacemacs-base/local/evil-evilified-state/evil-evilified-state.el
