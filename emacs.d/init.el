...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(agda2-highlight-bound-variable-face ((t (:foreground "brightmagenta"))))
 '(agda2-highlight-coinductive-constructor-face ((t (:foreground "brightred"))))
 '(agda2-highlight-datatype-face ((t (:foreground "blue"))))
 '(agda2-highlight-dotted-face ((t (:foreground "brightmagenta"))))
 '(agda2-highlight-field-face ((t (:foreground "green"))))
 '(agda2-highlight-function-face ((t (:foreground "green"))))
 '(agda2-highlight-inductive-constructor-face ((t (:foreground "brightred"))))
